...
public class NMSHandler1710 implements NMSAbstraction {
	...
	public boolean setWoodenTrapDoorFast(World world, int x, int y, int z, byte data) {
		...
		return chunk.a(x & 0x0f, y, z & 0x0f, Block.getById(96), data);
	}
