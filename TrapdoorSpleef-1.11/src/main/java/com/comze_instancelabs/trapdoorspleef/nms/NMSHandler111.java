...
import net.minecraft.server.v1_11_R1.BlockTrapdoor;
import net.minecraft.server.v1_11_R1.BlockTrapdoor.EnumTrapdoorHalf;
...
public class NMSHandler111 implements NMSAbstraction {
