pipeline {
   ...
   stages {
      ...
      stage ('Build') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'build of TrapdoorSpleef failed', body: 'build of TrapdoorSpleef failed'
              }
          }
      }
      ...
      stage ('Upload') {
        steps {
            ...
            sh "/srv/hudson/upload_game.sh ${env.BUILDTYPE} MGTrapdoorSpleef-Plugin/target 1 TrapdoorSpleef MGTrapdoorSpleef-Plugin"
      	}
      }
      ...
      stage ('Deploy') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'deploy of TrapdoorSpleef failed', body: 'deploy of TrapdoorSpleef failed'
              }
          }
      }
   }
