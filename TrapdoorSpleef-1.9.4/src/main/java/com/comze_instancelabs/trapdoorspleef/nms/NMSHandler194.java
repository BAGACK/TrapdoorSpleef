...
import net.minecraft.server.v1_9_R2.BlockTrapdoor;
import net.minecraft.server.v1_9_R2.BlockTrapdoor.EnumTrapdoorHalf;
...
public class NMSHandler194 implements NMSAbstraction {
