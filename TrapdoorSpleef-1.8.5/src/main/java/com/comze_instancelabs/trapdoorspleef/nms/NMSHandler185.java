...
import net.minecraft.server.v1_8_R2.BlockTrapdoor;
import net.minecraft.server.v1_8_R2.BlockTrapdoor.EnumTrapdoorHalf;
...
public class NMSHandler185 implements NMSAbstraction {
